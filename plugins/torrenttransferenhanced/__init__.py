...
class TorrentTransferEnhanced(_PluginBase):
        ...
        if self.get_state() or self._onlyonce:
            ...
            if self._autostart:
                ...
                self._scheduler.add_job(
                    self.check_recheck, 'interval', minutes=3)
    ...
    def transfer(self):
        ...
        for torrent in torrents:
            ...
            # 进度
            progress = self.__get_progress(torrent, downloader)
            # 排除不含有转移标签的种子
            if self._forcetrans:
                is_force = False
        ...
        if trans_torrents:
            ...
            for torrent_item in trans_torrents:
                ...
                torrent_info, _ = todownloader_obj.get_torrents(
                ...
                if torrent_info:
                    ...
                    if self._deleteduplicate:
                        ...
                        downloader_obj.delete_torrents(delete_file=False, ids=[
                ...
                if not download_id:
                    ...
                    success += 1
                    # 插入转种记录
                    history_key = "%s-%s" % (self._fromdownloader,
                                             torrent_item.get('hash'))
